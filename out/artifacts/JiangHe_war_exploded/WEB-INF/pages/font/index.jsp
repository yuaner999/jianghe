...
<ul class="home_items">
    ...
    <li><div></div><ul><a href="javascript:void(0)">师资队伍</a>
        <ol>
            <li><a href="newsList.form?newsDescribe=已通过&newsClass=兼职教师&type=3">兼职教师</a></li>
            <li><a href="newsList.form?newsDescribe=已通过&newsClass=专职教师&type=3">专职教师</a></li>
        </ol></ul>
    </li>
    <li><div></div><ul><a href="javascript:void(0)">教育教学</a>
        <ol>
            <li><a href="newsList.form?moduleType=e91e9e81-c04d-11e6-9c1a-00ac7dc2f176">学位委员会</a></li>
    ...
    <li><div></div><ul><a href="javascript:void(0)">学术研究</a>
        <ol>
            <li><a href="newsList.form?moduleType=7386cd02-c04e-11e6-9c1a-00ac7dc2f176">学术委员会</a></li>
    ...
    <li><div></div><ul><a href="javascript:void(0)">学生工作</a>
        <ol>
            <li><a href="newsList.form?moduleType=1e18a75a-c10e-11e6-a722-00ac7dc2f176">教育</a></li>
    ...
    <li><div></div><ul><a href="javascript:void(0)">交流合作</a>
        <ol>
            ...
            <li><a href="newsList.form?moduleType=6920f298-c10e-11e6-a722-00ac7dc2f176">校友交流</a></li>
        </ol></ul>
    </li>
...
<div class="contentNews">
    <div class="menu">
        <img src="<%=request.getContextPath()%>/asset_font/img/linksBg.png" />
        <ul>
            ...
            <li><a onclick="show(0)">通知公告</a><i class="inform"></i></li>
            <li><a onclick="show(1)">学院新闻</a><i class="schoolnews"></i></li>
            <li><a onclick="show(2)">学术活动</a><i class="collegenews"></i></li>
            <li><a onclick="show(3)">人才引进</a><i class="getTalents"></i></li>
            <li><a href="categoryNewsList.form?parentId=20d06f13-c04e-11e6-9c1a-00ac7dc2f176&parentName=本科生培养">本科生网</a><i class="undergraduate"></i></li>
            <li><a href="categoryNewsList.form?parentId=3a38fc2b-c04e-11e6-9c1a-00ac7dc2f176&parentName=研究生培养">研究生网</a><i class="graduate"></i></li>
        </ul>
    </div>
    ...
    <%--</div>--%>
    <div class="news">
        <h3>通知公告&nbsp;&nbsp;<span>NEWS</span>&nbsp;&nbsp;<i class="news_wifi"></i></h3>
        <ul>
            <c:forEach items="${announcementnewses}" var="item" begin="0" end="4">
                <li style="cursor: pointer">
                    <div class="newsItem">
                        <i></i>
                        <span onclick="go('${item.newsId}')"><span>${item.createDates}</span> &nbsp;&nbsp;&nbsp;&nbsp;<span> ${item.newsTitle}</span>&nbsp;&nbsp;&nbsp;&nbsp;<span>${item.newsDescribe}</span></span>
                        <a href="#" onclick="goto('${item.parentmenuid}','${item.moduleType}')">[更多]</a>
                    </div>
                </li>
            </c:forEach>
    ...
    <div class="news" style="display: none">
        <h3>学术活动&nbsp;&nbsp;<span>NEWS</span>&nbsp;&nbsp;<i class="news_wifi"></i></h3>
        <ul>
    ...
    <div class="news" style="display: none">
        <h3>人才引进&nbsp;&nbsp;<span>NEWS</span>&nbsp;&nbsp;<i class="news_wifi"></i></h3>
        <ul>
