...
//                    $('#box').progressbar('setValue', $('#box').progressbar('getValue') + 3);
//                }, 30);
//            }
////        }
//        function Add_before(){
...
<div id="tb" style="height:auto">
    ...
    <input class="easyui-searchbox" data-options="prompt:'请输入文件标题',searcher:doSearch" style="width:200px"/>
</div>
<%--对话框--%>
<div id="dlg" class="easyui-dialog hide" title=""
    ...
    <form id="Form">
        <div style="margin-bottom:10px;margin-top: 10px;display: none;">
            ...
            <input name="newsFile" hidden/>
        </div>
        <%--<div id="userphoto_box" style="height: 250px; width: 200px; float: right;background-size:100% 100%;">--%>
        <%--<img id="user_photo"  src="<%=request.getContextPath()%>/asset/image/default.jpg" onerror="onerror=null;src='<%=request.getContextPath()%>/asset/image/default.jpg'" style="width: 165px;--%>
        <%--height: 210px;margin-right: 50px;margin-top: 20px">--%>
        <%--<input name="newsIcon" hidden/>--%>
        <%--</div>--%>
        ...
        <%--<div style="margin-bottom:10px;margin-top: 10px;display: none">--%>
            ...
            <%--<input class="easyui-textbox" data-options="validType:'length[0,100]'"--%>
                   <%--name="newsClass" id="newsClass">--%>
        <%--</div>--%>
        <div style="margin-bottom:10px;margin-top: 10px;">
        ...
        <div  style="margin-bottom:10px;margin-top: 10px;">
            ...
            <input type="file" id="newsFile" name="newsFiles"   />
            <%--<div id="box" style="margin-left: 20px;margin-top: 10px"></div>--%>
        </div>
        <%--<div id="showFile" style="margin-bottom:10px;margin-top: 10px;">--%>
            <%--<span class="word">文件名称:</span>--%>
            <%--<input class="easyui-textbox" name="newsFile" readonly="readonly">--%>
        <%--</div>--%>
    </form>
    <%--<div style="margin-bottom:10px;margin-top: 10px;">--%>
