...
<table id="dg" class="easyui-datagrid" style="width:100%;min-height:556px;max-height: 100%;"
    ...
    <tr>
        ...
        <th field="newsTitle" width="100px">专业名称</th>
        <th field="newsDescribe" width="100px">专业描述</th>
...
<div id="dlg" class="easyui-dialog hide" title=""
    ...
    <div style="margin-bottom:10px;margin-top: 10px;">
        ...
        <textarea id="newsContent" name="newsContent" style="width:100%;height:450px;"></textarea>
    </div>
</div>
<%--对话框保存、取消按钮--%>
<div id="dlg-buttons">
