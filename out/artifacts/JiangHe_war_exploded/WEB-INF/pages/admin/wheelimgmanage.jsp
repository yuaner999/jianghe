...
//            });
            ...
            jsonObject.img=$("#file_upload_input").val();
            jsonObject.sort=$("#sort").val();
...
<table id="fontindexconfig_list" title="图片轮播" class="easyui-datagrid">
</table>

<div data-options="buttons:'#dlg-buttons',closed: true" id="dlg" class="easyui-dialog"
     style="width: 450px; height: 400px; padding: 20px 20px" title="对话框">
    <form id="Form">
