    ...
    <div data-options="region:'center',title:''">
        <div id="tt" class="easyui-tabs" style="height:100%;">
            <div title="首页" style="padding:20px;">
                <div class="index_box" style="margin-top: 14%;">
                    <img src="<%=request.getContextPath()%>/asset/image/manage/xiaohui.jpg" style="width: 270px;height: 250px;" />
                    <div class="index_box_title">江河建筑学院后台管理系统</div>
                </div>
            </div>
        </div>
    </div>
