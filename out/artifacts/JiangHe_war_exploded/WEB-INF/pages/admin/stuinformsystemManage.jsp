...
<head>
    ...
    <script>
        ...
        $(function(){
            $("#Board").fadeOut("slow");
            $('#dg').datagrid('options').queryParams={linkClass:"信息系统"};
...
<table id="dg" class="easyui-datagrid" style="width:100%;height: 100%;"
    ...
    <tr>
        ...
        <th field="linkName" style="width: 40%" >信息系统地址</th>
        <th field="linkContent" style="width: 30%" >信息系统名称</th>
