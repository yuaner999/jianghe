...
<head>
    ...
    <script>
        ...
        var addUrl = "/jsons/addModeType.form";
        var editUrl = "/jsons/editModeType.form";
        var deleteUrl = "/jsons/deleteModeType.form";
        var editorName = 'null';//KindEditor的Textarea的ID，如果没用到，赋值为null
        var imageUpload = "";//图片上传的标识，如果没有图片上传，赋值为空，如果有，赋值为数据库存放图片名称的字段名称，不带_
        var deleteId = "modelId";//用于删除功能的ID参数，赋值为当前数据库表的ID
...
<div id="tb" style="height:auto">
    ...
    <input class="easyui-searchbox" data-options="prompt:'请输入模块名',searcher:doSearch" style="width:200px"/>
</div>
<%--对话框--%>
<div id="dlg" class="easyui-dialog hide" title=""
     style="width:600px;height:520px;padding:10px; top: 0px"
    ...
    <form id="Form">
        ...
        <div style="margin-bottom:10px;margin-top: 10px;;display: none">
                ...
                <input class="easyui-textbox"
                       name="modelId" id="modelId" style="width:200px;height:32px">
        </div>
        <div style="margin-bottom:10px;margin-top: 10px;">
            <span class="word">模块名:</span>
            <input class="easyui-textbox" data-options="required:true,validType:'length[1,50]'"
                   name="modelName" id="modelName" style="width:200px;height:32px">
        </div>
