                                    ...
                                    success:function(data){
                                        ...
                                        if(data.rows&&data.rows.length>0){
                                            for(var j=0;j<data.rows.length;j++){
                                                var date=data.rows[i].newsDate.substring(0,data.rows[i].newsDate.indexOf(" "));
                                                str1='<li>'+
...
<div class="section">
    ...
    <ul class="imgBox">
        <li>
            <img class="load" src="<%=request.getContextPath()%>/Files/Images/img1_07.png" onerror="onerror=null;src='/asset_font/images/img1_07.png'" onclick="go('e3df07f5-c039-11e6-9c1a-00ac7dc2f176')"/>
        </li>
        <li>
            <img class="load" src="<%=request.getContextPath()%>/Files/Images/img2_07.png" onerror="onerror=null;src='/asset_font/images/img2_07.png'" onclick="go('f18f1f50-c039-11e6-9c1a-00ac7dc2f176')"/>
        </li>
        <li>
            <img class="load" src="<%=request.getContextPath()%>/Files/Images/img3_07.png" onerror="onerror=null;src='/asset_font/images/img3_07.png'" onclick="go('f9f94fe6-c039-11e6-9c1a-00ac7dc2f176')" />
        </li>
    ...
    <div class="news_box">
        <div class="news">
            <p>
                <span id="parentName">新闻</span><span></span>
            </p>
            <!--新闻列表
                    -->
            <div class="newsList">
