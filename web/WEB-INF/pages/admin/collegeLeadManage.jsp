...
<head>
    ...
    <script>
        ...
        $(function(){
            ...
            $('#dg').datagrid('options').url='/jsons/loadCollegeLeader.form';
            $('#dg').datagrid('reload');
...
<table id="dg" class="easyui-datagrid" style="width:100%;min-height:556px;max-height: 100%;"
    ...
    <tr>
        ...
        <th field="newsClass" width="100px">职务</th>
        <th field="newsDescribe" >显示顺序</th>
...
<div id="tb" style="height:auto">
    ...
    <input class="easyui-searchbox" data-options="prompt:'请输入姓名',searcher:doSearch" style="width:200px"/>
</div>
<%--对话框--%>
<div id="dlg" class="easyui-dialog hide" title=""
    ...
    <form id="Form">
        ...
        <div id="userphoto_box" style="height: 250px; width: 300px; float: right;background-size:100% 100%;">
            <img id="user_photo"  src="<%=request.getContextPath()%>/asset/image/default.jpg" onerror="onerror=null;src='<%=request.getContextPath()%>/asset/image/default.jpg'" style="width: 275px;
                height: 200px;margin-right: 50px;margin-top: 20px">
        ...
        <div style="margin-bottom:10px;margin-top: 10px;">
            <span class="word">领导职务:</span>
            <input class="easyui-textbox" data-options="required:true,validType:'length[0,100]'" name="newsClass" id="newsClass">
            <%--<select  name="newsClass" id="newsClass" style="width:172px;height:24px">--%>
                <%--<option value="党委书记">党委书记</option>--%>
                <%--<option value="执行院长">执行院长</option>--%>
        ...
        <div style="margin-bottom:10px;margin-top: 10px;">
            <span class="word">显示顺序:</span>
            <input class="easyui-textbox" data-options="required:true,validType:'length[0,100]'" name="newsDescribe" id="newsDescribe">
        </div>
        <div style="margin-bottom:10px;margin-top: 10px;">
