...
<head>
    ...
    <script>
        ...
        $(function(){
            $("#Board").fadeOut("slow");
            $('#dg').datagrid('options').queryParams={linkClass:"友情链接"};
...
<table id="dg" class="easyui-datagrid" style="width:100%;height: 100%;"
    ...
    <tr>
        ...
        <th field="linkName" style="width: 40%" >链接的地址</th>
        <th field="linkContent" style="width: 30%" >链接的名称</th>
