...
<head>
    ...
    <script>
        ...
        $(function(){
            ...
            $('#dg').datagrid('options').url='/jsons/loadStutsTeacher.form';
            $('#dg').datagrid('reload');
        ...
        function Saves(){
            if($("#Form").form('validate')){
                ...
                if($("#newsClass").combobox("getValue")=="专职教师"){
                    jsonObject["moduleType"] = "d78fff10-c10c-11e6-a722-00ac7dc2f176";
                }
                if($("#newsClass").combobox("getValue")=="兼职教师"){
                    jsonObject["moduleType"] = "f4d9dac1-c446-11e6-b626-00ac7dc2f176";
                }
...
<table id="dg" class="easyui-datagrid" style="width:100%;min-height:556px;max-height: 100%;"
    ...
    <tr>
        ...
        <th field="newsDates" width="100px">日期</th>
            <th field="newsDescribe" width="100px">审核状态</th>
...
<div id="tb" style="height:auto">
    ...
    <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true" onclick="Edit()">审核</a>
...
<div id="dlg" class="easyui-dialog hide" title=""
     style="width:710px;height:550px;padding:10px;"
    ...
    <form id="Form">
        ...
        <div style="margin-bottom:10px;margin-top: 10px;">
            ...
            <input class="easyui-textbox" data-options="required:true,validType:'length[0,100]'"
                   name="newsTitle" id="newsTitle" readonly>
        </div>
        <div style="margin-bottom:10px;margin-top: 10px;">
            <span class="word"><span style="letter-spacing: 30px">分</span>类:</span>
            <select class="easyui-combobox" name="newsClass" id="newsClass"
                    data-options="required:false,editable:false,panelHeight:'auto'" style="width:175px;!important;height:22px;!important;" readonly>
        ...
        <div style="margin-bottom:10px;margin-top: 10px;">
            ...
            <input class="easyui-datebox" name="newsDate" id="newsDate" data-options="required:true,editable:false" readonly>
        </div>
        <%--<div style="margin-bottom:10px;margin-top: 10px;">--%>
            <%--<span class="word"><span style="letter-spacing: 30px">图</span>片:</span>--%>
            <%--<input  type="file" name="newsicons" id="newsIcon" onchange='preview(this)' readonly/>--%>
        <%--</div>--%>
        <div style="margin-bottom:10px;margin-top: 10px;">
            <span class="word"><span style="letter-spacing: 30px">审</span>核:</span>
            <select class="easyui-combobox" name="newsDescribe" id="newsDescribe"
    ...
    <div style="margin-bottom:10px;margin-top: 10px;">
        <div class="word" style="letter-spacing: 3px;margin-top: 62px;">内容:</div>
        <textarea id="newsContent" name="newsContent" style="width:100%;height:300px;" readonly></textarea>
    </div>
</div>
<%--对话框保存、取消按钮--%>
<div id="dlg-buttons">
