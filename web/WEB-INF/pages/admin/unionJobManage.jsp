...
<head>
    ...
    <script>
        ...
        var commendUrl = "/jsons/commendNews.form";
...
<table id="dg" class="easyui-datagrid" style="width:100%;min-height:556px;max-height: 100%;"
    ...
    <tr>
        ...
        <th field="newsAuthor" width="100px">人员</th>
...
<div id="tb" style="height:auto">
    ...
    <a href="javascript:void(0)" class="easyui-linkbutton" data-options="plain:true" onclick="Commend()">推荐到学院新闻</a>
    <input class="easyui-searchbox" data-options="prompt:'请输入工作标题',searcher:doSearch" style="width:200px"/>
</div>
<%--对话框--%>
<div id="dlg" class="easyui-dialog hide" title=""
    ...
    <form id="Form">
        ...
        <%--<div style="margin-bottom:10px;margin-top: 10px;">--%>
            <%--<span class="word">图片:</span>--%>
            <%--<input  type="file"  id="newsIcon"  name="newsico" onchange='preview(this)'/>--%>
        <%--</div>--%>
        <div style="margin-bottom:10px;margin-top: 10px;">
            <span class="word"><span style="letter-spacing: 30px">人</span>员:</span>
        ...
        <div style="margin-bottom:10px;margin-top: 10px;">
            ...
            <input class="easyui-textbox" data-options="multiline:true,validType:'length[0,200]'"
                   name="newsDescribe" id="newsDescribe" style="height: 50px;width: 174px">
        </div>
        <div style="margin-bottom:10px;margin-top: 10px;">
        ...
        <div style="margin-bottom:10px;margin-top: 10px;">
            <span class="word" style="margin-left: -80px;">是否启用:</span>
